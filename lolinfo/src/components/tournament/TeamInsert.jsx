    ...
    <div className="row mt-2">
        ...
        <div className="col-sm-9">
            <input type="text" className={`form-control ${teamClass.teamTop}`} 
                        ...
                        />
            <div className="valid-feedback"></div>
            <div className="invalid-feedback">탑유저가 일치하지 않습니다</div>
        </div>
    </div>
    {/* JUG */}
    <div className="row mt-2">
        ...
        <div className="col-sm-9">
            <input type="text" className={`form-control ${teamClass.teamJug}`} 
                        ...
                        />
            <div className="valid-feedback"></div>
            <div className="invalid-feedback">정글유저가 일치하지 않습니다</div>
        </div>
    </div>
    {/* MID */}
    <div className="row mt-2">
        ...
        <div className="col-sm-9">
            <input type="text" className={`form-control ${teamClass.teamMid}`} 
                        ...
                        />
            <div className="valid-feedback"></div>
            <div className="invalid-feedback">미드유저가 일치하지 않습니다</div>
        </div>
    </div>
    {/* AD */}
    <div className="row mt-2">
        ...
        <div className="col-sm-9">
            <input type="text" className={`form-control ${teamClass.teamAd}`} 
                        ...
                        />
            <div className="valid-feedback"></div>
            <div className="invalid-feedback">원딜유저가 일치하지 않습니다</div>
        </div>
    </div>
    {/* SUP */}
    <div className="row mt-2">
        ...
        <div className="col-sm-9">
            <input type="text" className={`form-control ${teamClass.teamSup}`} 
                        ...
                        />
            <div className="valid-feedback"></div>
            <div className="invalid-feedback">서폿유저가 일치하지 않습니다</div>
        </div>
    </div>
